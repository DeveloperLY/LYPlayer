...
- (void)setup {
    [self setThumbImage:kImageNamed(@"ic_slider_thumb_30x30_") forState:UIControlStateHighlighted];
    [self setThumbImage:kImageNamed(@"ic_slider_thumb_30x30_") forState:UIControlStateNormal];
}

// 控制 slider 的宽和高，这个方法才是真正的改变 slider 滑道的高的
