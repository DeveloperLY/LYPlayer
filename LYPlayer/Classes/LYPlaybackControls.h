...
/** 播放器控制面板代理 */
@protocol LYPlaybackControlsDelegate <NSObject>
...
@interface LYPlaybackControls : UIView
...
/** 播放器控制面板代理 */
@property (nonatomic, weak) id <LYPlaybackControlsDelegate> delegate;
/** 隐藏控制面板延时时间 缺省5s */
