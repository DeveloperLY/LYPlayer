...
@implementation LYPlaybackControls
...
- (void)_showOrHideStatusBar {
    switch (_statusBarHideState) {
        case LYStatusBarHideStateFollowControls: {
            [[UIApplication sharedApplication] setStatusBarHidden:!self.isShowing];
        }
            break;
        case LYStatusBarHideStateNever: {
            [[UIApplication sharedApplication] setStatusBarHidden:NO];
        }
            break;
        case LYStatusBarHideStateAlways: {
...
- (UIButton *)playButton {
    if (!_playButton) {
        ...
        [_playButton setImage:kImageNamed(@"btn_play") forState:UIControlStateNormal];
        [_playButton setImage:kImageNamed(@"btn_pause") forState:UIControlStateSelected];
...
- (UIButton *)fullScreenButton {
    if (!_fullScreenButton) {
        ...
        [_fullScreenButton setImage:kImageNamed(@"ic_turn_screen_white_18x18_") forState:UIControlStateNormal];
        [_fullScreenButton setImage:kImageNamed(@"ic_zoomout_screen_white_18x18_") forState:UIControlStateSelected];
...
- (UIButton *)retryButton {
    if (!_retryButton) {
        ...
        [_retryButton setImage:kImageNamed(@"Action_reload_player_100x100_") forState:UIControlStateNormal];
...
- (LYSlider *)videoSlider {
    if (!_videoSlider) {
        _videoSlider = [[LYSlider alloc] init];
